...
export interface IPersonalizedWhyAttendFields {
  /** List Name */
  name: string;
...
export interface IPersonalizedWhyAttend
  extends Entry<IPersonalizedWhyAttendFields> {
  sys: {
    id: string;
    type: string;
    createdAt: string;
